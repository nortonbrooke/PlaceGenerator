...
const PrivacyPolicy = () => {
  return (
    <div className='App-policy'>
      ...
      <p>
        Our website uses Google Analytics to track and report our website traffic.
        This is done by use of cookies to collect data. For more information on
        how we use cookies, visit section <a href='#cookies'>8. Cookies</a>. For
        more information on how Google Analytics collects and processes data,
        please refer to{' '}
      ...
      <p>
        To provide visitors more choice on how their data is collected by Google
        Analytics, Google has developed an Opt-out Browser add-on, which is
      ...
      <p>
        ...
        visit to our websites and/or other websites on the Internet. You may opt out
      ...
      <h3>6. International transfers of personal information</h3>
      <p>
      ...
      <h3>7. Your rights and controlling your personal information</h3>
      <p>
      ...
      <h3 id='cookies'>8. Cookies</h3>
      <p>
        We use “cookies” to collect information about you and your activity
        across our website. A cookie is a small piece of data that our website
      ...
      <p>
        Our website may link to external websites that are not operated by us.
        Please be aware that we have no control over the content and policies of
        those websites, and cannot accept responsibility or liability for their
      ...
      <p>
        ...
        about changes via our website. Your continued use of this website after any
