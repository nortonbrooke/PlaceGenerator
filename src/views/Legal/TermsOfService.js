  ...
  return (
    <div className='policy'>
      ...
      <p>
        ...
        terms, you are prohibited from using or accessing this website. The
        materials contained in this website are protected by applicable
        copyright and trademark law.
      </p>
      <h3>2. Google Terms of Service</h3>
      <p>
        Our website uses Google Maps API(s). By using this application, you are
        bound by{' '}
