  ...
  return (
    <div className="policy">
      ...
      <p>
        ...
        web browser when you return, additional data that serves the purpose
        of the cookie, and the lifespan of the cookie itself.
      </p>
      <p>
        Cookies are used to enable certain features (eg. logging in), to track
        website usage (eg. analytics), to store your user settings (eg.
        timezone, notification preferences), and to personalize your content
      ...
      <p>
        ...
        that particular website. Cookies set by other websites and companies
        (ie. third parties) are called “third-party cookies”, and can be used
      ...
      <p>
        ...
        information tracked across all website users, to help companies
        ...
        third-party services. We use performance cookies on our website.
      </p>
      ...
      <p>
        ...
        websites can provide you with customized, enhanced or optimized
      ...
      <p>
        ...
        use targeting/advertising cookies on our website.
      </p>
      <h3>Third-party cookies on our website</h3>
      <p>
      ...
      <p>
        ...
        to access certain features and content across the websites you visit.
      </p>
    </div>
  );
}
